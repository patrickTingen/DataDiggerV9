...
/* <JAG> - Support V9 (compile-time) - WIDGET-ID en INT64 niet ondersteund </JAG> */
...
DEFINE VARIABLE fiFileSize AS DECIMAL FORMAT ">>>,>>>,>>>,>>9":U INITIAL 0    /* <JAG> - Support V9 (compile-time) - </JAG> */
     LABEL "Data Size" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME frDataSettings
     fiDataFile AT Y 0 X 0 NO-LABEL
     fiFileContents AT Y 25 X 0 NO-LABEL
     cbSeparator AT Y 510 X 90 COLON-ALIGNED
     fiTimestamp AT Y 510 X 470 COLON-ALIGNED
     fiTargetDatabase AT Y 510 X 755 COLON-ALIGNED
     cbDateFormat AT Y 535 X 90 COLON-ALIGNED
     fiYearOffset AT Y 535 X 305 COLON-ALIGNED
     fiNumRecords AT Y 535 X 470 COLON-ALIGNED
     fiTargetTable AT Y 535 X 755 COLON-ALIGNED
     cbNumericFormat AT Y 560 X 90 COLON-ALIGNED
     fiFileSize AT Y 560 X 470 COLON-ALIGNED
     "bytes" VIEW-AS TEXT
          SIZE 6.4 BY .62 AT ROW 27.91 COL 112
     RECT-3 AT ROW 24.81 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT X 0 Y 0
         SIZE-PIXELS 978 BY 599.
...
define variable cLine          as character   no-undo.
  ...
  define variable cFileData      as {&longchar} no-undo.    /* <JAG> - Support V9 (compile-time) - </JAG> */
  ...
  define variable iFileSize       as {&int64}   no-undo.    /* <JAG> - Support V9 (compile-time) - </JAG> */
  define variable iActualFileSize as {&int64}   no-undo.    /* <JAG> - Support V9 (compile-time) - </JAG> */
  ...
  /* <JAG> - Support V9 (compile-time) - copy-lob niet ondersteund */
  /*
