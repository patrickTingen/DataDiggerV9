...
&if integer(entry(1, proversion, ".")) >= 10 &then
  &global-define datetime-v datetime
  &global-define datetime-f "99-99-9999 HH:MM:SS"
  &global-define now        now
  &global-define longchar   longchar
  &global-define int64      int64
&else
  &global-define datetime-v date
  &global-define datetime-f "99-99-9999"
  &global-define now        today
  &global-define longchar   character
  &global-define int64      decimal
&endif
/* </JAG> - Support V9 (compile-time) */
...
define temp-table ttTable no-undo rcode-information
  ...
  field cShowDatabase as character      label 'DB'        format 'x(10)'          /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
  field cTableDesc    as character      label 'Desc'      
  field lHidden       as logical        label 'H'         
  field iNumQueries   as integer        label '#'         format 'zzzzz'
  field tLastUsed     as {&datetime-v}  label 'Last Used' format {&datetime-f}    /* <JAG> - Support V9 (compile-time) - </JAG> */
