...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brFields wEdit _FREEFORM
  QUERY brFields DISPLAY
      ttField.lShow      column-label ''  /* view-as toggle-box */    /* <JAG> - Support V9 (compile-time) </JAG> */
  ttField.cFullName 
  ttField.cLabel      format "x(48)"      /* <JAG> - Support V9 (verbetering) - format vergroot </JAG> */
  ttField.cNewValue
  enable 
/* ttField.lShow */                       /* <JAG> - Support V9 (run-time) - toggle-box werkt niet in V9, niet meer enablen </JAG> */
  ttField.cNewValue
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME frEdit
     brFields AT Y 5 X 0
     fiNumRecords AT Y 465 X 90 COLON-ALIGNED
     btnOk AT Y 465 X 505
     btnClose AT Y 465 X 585
...
THEN wEdit:HIDDEN = yes.    /* <JAG> - Support V9 (verbetering) - voorkom 'flikkeringen' </JAG> */
...
DO:
  ...
  do with frame {&frame-name}:
    ...
    find ttField where ttField.cFullName = string(brFields:get-browse-column(2):buffer-field('cFullName'):buffer-value).  /* <JAG> - Support V9 (compile-time) </JAG> */
...
------------------------------------------------------------------------------*/
  ...
  /* VIEW wEdit. */   /* <JAG> - Support V9 (verbetering) - voorkom 'flikkeringen' </JAG> */
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  do with frame {&frame-name}:
    brFields:get-browse-column(2):width-chars = iMaxFieldLength + 2 no-error.   /* <JAG> - Support V9 (run-time) - voorkom: "Invalid width (1) specified for FILL-IN cFullName. It cannot be less than MIN-COLUMN-WIDTH (1) for BROWSE FILL-IN cFullName. (9960)"  </JAG> */
  ...
  wEdit:hidden = no.    /* <JAG> - Support V9 (verbetering) - voorkom 'flikkeringen' </JAG> */
