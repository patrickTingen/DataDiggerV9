...
/* <JAG> - Support V9 (compile-time) - WIDGET-ID en DATETIME niet ondersteund - dit window graag niet opslaan in de AppBuilder (wordt dan verminkt) </JAG> */
...
&Scoped-define FIELDS-IN-QUERY-brFields ttField.lShow /* view-as toggle-box */ /* <JAG> - Support V9 (compile-time) </JAG> */ ttField.iOrder ttField.cFieldName (if ttField.iExtent > 0 then substitute('&1[&2]', ttField.cDataType, ttField.iExtent) else ttField.cDataType ) @ ttField.cDataType ttField.cFormat ttField.cLabel /* <JAG> - Support V9 (verbetering) - </JAG> */   
...
&Scoped-define FIELDS-IN-QUERY-brTables ttTable.cTableName ttTable.cShowDatabase /* <JAG> - Support AS400 (FC specifiek) - ttTable.cDatabase vervangen door ttTable.cShowDatabase - </JAG> */ ttTable.iNumQueries ttTable.tLastUsed   
...
btnFieldFilter fiIndexNameFilter fiFlagsFilter fiFieldsFilter ~
btnClearIndexFilter btnIndexFilter tgSelAll brFields btnAddFilter ~
btnAddFilter2 btnTabIndexes brIndexes fiTableFilter cbDatabaseFilter ~
...
btnDataFilter btnAdd btnEdit btnDelete btnView btnDump btnLoad fiNumresults 
...
DEFINE VARIABLE fiLastUsedFilter AS DATE FORMAT "99/99/9999":U 
     CONTEXT-HELP-ID 950
     VIEW-AS FILL-IN 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brFields C-Win _FREEFORM
  QUERY brFields DISPLAY
      ttField.lShow /* view-as toggle-box */    /* <JAG> - Support V9 (compile-time) </JAG> */
  ttField.iOrder     
  ttField.cFieldName 
  ...
  ttField.cFormat    
  ttField.cLabel  format "x(48)"    /* <JAG> - Support V9 (verbetering) - format vergroot </JAG> */
  enable 
  ttField.lShow 
  ttField.cFormat
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-VALIDATE
          ...
          &ELSE SIZE-PIXELS 500 BY 196 &ENDIF ROW-HEIGHT-CHARS .62 EXPANDABLE TOOLTIP "fields of selected table"
         CONTEXT-HELP-ID 80.
...
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-VALIDATE
          ...
          &ELSE SIZE-PIXELS 308 BY 193 &ENDIF EXPANDABLE TOOLTIP "indexes of the table"
         CONTEXT-HELP-ID 90.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTables C-Win _FREEFORM
  QUERY brTables DISPLAY
      ttTable.cTableName  
      ttTable.cShowDatabase     /* <JAG> - Support AS400 (FC specifiek) - ttTable.cDatabase vervangen door ttTable.cShowDatabase - </JAG> */
      ttTable.iNumQueries 
      ttTable.tLastUsed
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS
          ...
          &ELSE SIZE-PIXELS 220 BY 144 &ENDIF EXPANDABLE
         CONTEXT-HELP-ID 70.
...
DEFINE FRAME frMain
     btnTabFields AT Y 45 X 230
     btnDataDigger AT Y 5 X 5
     btnTools AT Y 5 X 35
     btnHelp AT Y 5 X 65
     btnQueryTester AT Y 5 X 95
     fiOrderFilter AT Y 5 X 265 COLON-ALIGNED NO-LABEL
     fiNameFilter AT Y 5 X 300 COLON-ALIGNED NO-LABEL
     fiTypeFilter AT Y 5 X 485 COLON-ALIGNED NO-LABEL
     fiFormatFilter AT Y 5 X 540 COLON-ALIGNED NO-LABEL
     fiLabelFilter AT Y 5 X 615 COLON-ALIGNED NO-LABEL
     btnClearFieldFilter AT Y 5 X 710
     btnFieldFilter AT Y 5 X 731
     fiIndexNameFilter AT Y 5 X 785 COLON-ALIGNED NO-LABEL
     fiFlagsFilter AT Y 5 X 860 COLON-ALIGNED NO-LABEL
     fiFieldsFilter AT Y 5 X 915 COLON-ALIGNED NO-LABEL
     btnClearIndexFilter AT Y 5 X 1065
     btnIndexFilter AT Y 5 X 1086
     tgSelAll AT Y 7 X 259
     brFields AT Y 27 X 255
     btnAddFilter AT Y 27 X 760
     btnAddFilter2 AT Y 27 X 1110
     btnTabIndexes AT Y 130 X 230
     brIndexes AT Y 28 X 799
     fiTableFilter AT Y 37 X 5 NO-LABEL
     cbDatabaseFilter AT Y 37 X 66 COLON-ALIGNED NO-LABEL
     fiNumQueriesFilter AT Y 37 X 155 NO-LABEL
     fiLastUsedFilter AT Y 37 X 170 NO-LABEL
     btnClearTableFilter AT Y 37 X 185
     btnTableFilter AT Y 37 X 205
     btnEditFilter AT Y 49 X 760
     btnEditFilter2 AT Y 49 X 1110
     brTables AT Y 59 X 5
     btnRemoveFilter AT Y 71 X 760
     btnRemoveFilter2 AT Y 71 X 1110
     btnMoveTop AT Y 112 X 760
     btnMoveUp AT Y 134 X 760
     btnReset AT Y 156 X 760
     btnMoveDown AT Y 178 X 760
     btnMoveBottom AT Y 200 X 760
     fiTableDesc AT Y 202 X 5 NO-LABEL
     btnWhere AT Y 225 X 5
     btnViewData AT Y 225 X 651
     btnClear AT Y 225 X 671
     btnPrevQuery AT Y 225 X 691
     btnQueries AT Y 225 X 703
     btnNextQuery AT Y 225 X 723
     btnClipboard AT Y 225 X 735
     ficWhere AT Y 227 X 60 NO-LABEL
     btnClearDataFilter AT Y 265 X 10
     btnDataFilter AT Y 265 X 30
     tgDebugMode AT ROW 13.86 COL 19
     fiWarning AT Y 395 X 725 COLON-ALIGNED NO-LABEL
     btnAdd AT Y 535 X 5
     btnEdit AT Y 535 X 55
     btnDelete AT Y 535 X 105
     btnView AT Y 535 X 190
     btnDump AT Y 535 X 270
     btnLoad AT Y 535 X 350
     fiIndexInfo AT Y 537 X 455 COLON-ALIGNED NO-LABEL
     fiNumresults AT Y 520 X 685 COLON-ALIGNED NO-LABEL
     "#" VIEW-AS TEXT
          SIZE-PIXELS 10 BY 13 AT Y 13 X 150
          FGCOLOR 7 
     rctData AT Y 255 X 0
     rctQuery AT Y 0 X 0
     rctEdit AT Y 530 X 0
     rcCounter AT Y 10 X 160
     rcTableFilter AT ROW 3.67 COL 1.4
     rcFieldFilter AT ROW 2.14 COL 51.4
     rcIndexFilter AT ROW 2.14 COL 160
...
DEFINE FRAME frSettings
     btnSettings AT Y 1 X 1
     btnAbout-txt AT Y 187 X 32
     btnFavorites AT Y 32 X 1
     btnDump-2 AT Y 63 X 1
     btnLoad-2 AT Y 94 X 1
     btnQueries-3 AT Y 125 X 1
     btnChangeLog AT Y 156 X 1
     btnAbout AT Y 187 X 1
     btnChangeLog-txt AT Y 156 X 32
     btnDump-txt AT Y 63 X 32
     btnFavorites-txt AT Y 32 X 32
     btnLoad-txt AT Y 94 X 32
     btnQueries-txt AT Y 125 X 32
     btnSettings-txt AT Y 1 X 32
...
DEFINE FRAME frWhere
     btnAnd AT Y 98 X 15
     cbAndOr AT Y 5 X 35 COLON-ALIGNED
     cbFields AT Y 5 X 76 COLON-ALIGNED NO-LABEL
     cbOperator AT Y 5 X 286 COLON-ALIGNED NO-LABEL
     ficValue AT Y 5 X 371 COLON-ALIGNED NO-LABEL
     btnInsert AT Y 5 X 595
     ficWhere2 AT Y 35 X 86 NO-LABEL
     btnViewData-2 AT Y 210 X 90
     btnClear-2 AT Y 210 X 110
     btnPrevQuery-2 AT Y 210 X 130
     btnQueries-2 AT Y 210 X 140
     btnNextQuery-2 AT Y 210 X 160
     btnClipboard-2 AT Y 210 X 170
     btnOK AT Y 210 X 460
     btnCancel-2 AT Y 210 X 540
     btnBegins AT Y 120 X 15
     btnBracket AT Y 77 X 15
     btnContains AT Y 140 X 15
     btnEq AT Y 35 X 15
     btnGT AT Y 56 X 45
     btnLT AT Y 56 X 15
     btnMatches AT Y 161 X 15
     btnNE AT Y 35 X 45
     btnOr AT Y 98 X 45
     btnQt AT Y 77 X 45
     btnToday AT Y 182 X 15
...
/* BROWSE-TAB brIndexes btnTabIndexes frMain */
...
do:
  ...
  do with frame {&frame-name}:
    ...
    hField = brFields:get-browse-column(3):handle.
    find ttField where ttField.cFullName = hField:screen-value no-error.
    /* </JAG> - Support V9 (compile-time) */
...
DO:
    ...
    do iField = 1 to num-entries(gcFieldBrowseColumnHandles):
      hField = widget-handle(entry(iField,gcFieldBrowseColumnHandles)). /* <JAG> - Support V9 (compile-time) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brFields C-Win
ON VALUE-CHANGED OF brFields IN FRAME frMain
DO:
...
DO:
  ...
  do iField = 1 to num-entries(gcIndexBrowseColumnHandles):
    hField = widget-handle(entry(iField,gcIndexBrowseColumnHandles)). /* <JAG> - Support V9 (compile-time) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brIndexes C-Win
ON VALUE-CHANGED OF brIndexes IN FRAME frMain
DO:
...
do:
  ...
  do:
    /* <JAG> - Support V9 (compile-time) */
    gcCurrentTable    = brTables:query:get-buffer-handle(1):buffer-field('cTableName'):buffer-value.
    gcCurrentDatabase = brTables:query:get-buffer-handle(1):buffer-field('cDatabase'):buffer-value.
    /* </JAG> - Support V9 (compile-time) */
...
DO:
  ...
  cField = brFields:query:get-buffer-handle(1):buffer-field('cFieldName'):buffer-value.  /* <JAG> - Support V9 (compile-time) - </JAG> */
...
DO:
  ...
  find ttIndex where ttIndex.cIndexName = string(brIndexes:query:get-buffer-handle(1):buffer-field('cIndexName'):buffer-value) no-error. /* <JAG> - Support V9 (compile-time) - </JAG> */
...
DO:
  ...
  setRegistry ( substitute('DB:&1'   , getDatabaseName("TO-DATASR", getCurrentDatabase()) )   /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
...
DO:
  ...
  do with frame {&frame-name}:
    ...
    if hBuffer:available then 
      cCurrentDb = hBuffer:buffer-field('cDatabase'):buffer-value.  /* <JAG> - Support V9 (compile-time) - </JAG> */
    else 
      return.
  end.
...
do:
  ...
  /* Save settings */
  /* <JAG> - Support V9 (verbetering) - coordinaten en grootte niet opslaan als DD niet 'normal' (bijv 'minimized' of 'maximized') is */
  if c-win:window-state = 3 then    /* 3 = WINDOW-NORMAL */
  do:
    setRegistry("DataDigger", "Window:x", string(c-win:x) ).
    setRegistry("DataDigger", "Window:y", string(c-win:y) ).
  end.
...
/*------------------------------------------------------------------------
  ...
  */
  ...
  repeat while not hQuery:query-off-end:
    find ttIndex where ttIndex.cIndexName = string(hBufferIndex:buffer-field('_index-name'):buffer-value) no-error.   /* <JAG> - Support V9 (compile-time) - </JAG> */
...
/*------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------*/
  define input parameter hBrowseBuffer as handle  no-undo.
  define input parameter hQuery        as handle  no-undo.  /* <JAG> - Support V9 (run-time) </JAG> */
  
  /* <JAG> - Support V9 (run-time) - hBrowseBuffer:query hier vervangen door hQuery ivm "**QUERY is not a queryable attribute for BUFFER widget. (4052)"  </JAG> */
  ...
  for each ttField:
    ...
    ttField.hColumn:bgcolor = (if hQuery:current-result-row modulo 2 <> 1 then ? else 8).
...
/*------------------------------------------------------------------------
  ...
  run value(getProgramDir() + 'dDump.w')
    ...
    , input table ttField /* by-reference */    /* <JAG> - Support V9 (compile-time) - by-reference kent ie niet </JAG> */
    ).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btnTabFields rctData rctQuery rctEdit rcCounter btnDataDigger btnTools 
         ...
         btnIndexFilter tgSelAll brFields btnAddFilter btnAddFilter2 
         btnTabIndexes brIndexes fiTableFilter cbDatabaseFilter 
         fiNumQueriesFilter fiLastUsedFilter btnClearTableFilter btnTableFilter 
         btnEditFilter btnEditFilter2 brTables btnMoveTop btnMoveUp btnReset 
         btnMoveDown btnMoveBottom fiTableDesc btnWhere btnClear btnPrevQuery 
         btnQueries btnNextQuery btnClipboard ficWhere btnClearDataFilter 
...
/*------------------------------------------------------------------------
  ...
  iQueriesServed = integer( getRegistry( substitute('DB:&1'           , getDatabaseName("TO-DATASR", pcDatabase) )  /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
  ...
  assign 
    ...
    bTable.tLastUsed   = {&now}.                                                          /* <JAG> - Support V9 (compile-time) - </JAG> */

  /* Save in registry */
  setRegistry ( substitute('DB:&1'           , getDatabaseName("TO-DATASR", pcDatabase) ) /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
              , substitute('&1:QueriesServed', pcTable )
              , string(bTable.iNumQueries) 
              ).
  setRegistry ( substitute('DB:&1'      , getDatabaseName("TO-DATASR", pcDatabase) )      /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
              , substitute('&1:LastUsed', pcTable )
              , string(bTable.tLastUsed , {&datetime-f})                                  /* <JAG> - Support V9 (compile-time) - </JAG> */
              ).
...
/*     tgDebugMode:hidden  = &IF DEFINED (UIB_is_running) &THEN no. &ELSE yes. &ENDIF */
    ...
    do iField = 1 to brTables:num-columns:
      ...
      /* <JAG> - Support V9 (verbetering) - kolom "tLastUsed" niet zo relevant </JAG> */
      if hColumn:name = "tLastUsed" then
        assign
          hColumn:visible = no
          iValue          = 1.
      /* </JAG> - Support V9 (verbetering) */
    ...
    c-win:hidden = yes.   /* <JAG> - Support V9 (verbetering) - hide window, voorkom 'flikkeringen' </JAG> */
    ...
    if cSetting <> ? then
    do:
      /* brFields:set-sort-arrow(integer(entry(1,cSetting)), logical(entry(2,cSetting)) ). */ /* <JAG> - Support V9 (compile-time) - set-sort-arrow niet ondersteund </JAG> */
    end.
    ...
    if cSetting <> ? then
    do:
      /* brIndexes:set-sort-arrow(integer(entry(1,cSetting)), logical(entry(2,cSetting)) ). */  /* <JAG> - Support V9 (compile-time) - set-sort-arrow niet ondersteund </JAG> */
    end.
    ...
    if cSetting <> ? then
    do:
      /* brTables:set-sort-arrow(integer(entry(1,cSetting)), logical(entry(2,cSetting)) ). */ /* <JAG> - Support V9 (compile-time) - set-sort-arrow niet ondersteund </JAG> */
    end.
  ...
  c-win:hidden = no.  /* <JAG> - Support V9 (verbetering) - hide window, voorkom 'flikkeringen' </JAG> */
...
/*------------------------------------------------------------------------
  ...
  find ttFieldOrg where rowid(ttFieldOrg) = to-rowid(string(browse brFields:query:get-buffer-handle(1):rowid)) no-error.    /* <JAG> - Support V9 (compile-time) - </JAG> */
...
/*------------------------------------------------------------------------
  ...
  cDatabase = getDatabaseName("TO-DATASR", cDatabase).  /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
  ...
  create browse ghDataBrowse
    ...
    sensitive         = true
    visible           = false
 /* no-validate       = true */   /* <JAG> - Support V9 (run-time) - no-validate niet ondersteund </JAG> */
    ...
    triggers:
      ...
      on 'ROW-DISPLAY'      persistent run dataRowDisplay      in this-procedure (hBrowseBuffer, hQuery).   /* <JAG> - Support V9 (run-time) </JAG> */
  ...
  for each ttField where ttField.lDataField = true by ttField.iOrder:
    ...
    do:
      ...
      do:
        ...
        setRegistry( substitute('DB:&1'       , getDatabaseName("TO-DATASR", cDatabase) )   /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
    ...
    do:
      /* ghDataBrowse:set-sort-arrow(iColumn, lAscending ). */  /* <JAG> - Support V9 (compile-time) - set-sort-arrow niet ondersteund </JAG> */
    end.
  ...
  /* Show the browse */
  ghDataBrowse:visible = TRUE NO-ERROR.
...
/*------------------------------------------------------------------------
  ...
  /* <JAG> - Support V9 (run-time) - voorkom: "** Unable to understand after -- "lMetaField = true". (247)" */
  if cNewSort = "" then
    assign
      cQuery = replace(cQuery, " by ", "")
      cQuery = replace(cQuery, " descending", "").
  cQuery = trim(cQuery).
  /* </JAG> - Support V9 (run-time) */
  ...
  hQuery:get-first.
  repeat while not hQuery:query-off-end:
    hBuffer:buffer-field('lVisible'):buffer-value = true.   /* <JAG> - Support V9 (compile-time) */
    lFieldsFound = true.
    hQuery:get-next.
  end.
  ...
  brFields:query in frame {&frame-name} = hQuery no-error.  /* <JAG> - Support V9 (run-time) - voorkom: "Cannot Get on query  which is not opened. (3159)" */
...
/*------------------------------------------------------------------------
  ...
  define variable tLastUsedFilter   as {&datetime-v} no-undo.   /* <JAG> - Support V9 (compile-time) </JAG> */

  do with frame {&frame-name}:

    /* Get filters */
    cTableFilter      = getMatchesValue(fiTableFilter:handle).
    cDatabaseFilter   = getDatabaseName("TO-SCHEMA", cbDatabaseFilter:screen-value).    /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
    ...
    tLastUsedFilter   = date(fiLastUsedFilter:screen-value) no-error.                   /* <JAG> - Support V9 (compile-time) </JAG> */
    ...
    if cDatabaseFilter = "PPROGKV" then
      cDatabaseFilter = "schemahr".
    ...
    /* Attach query to the browse */
    brTables:query in frame {&frame-name} = hQuery no-error.  /* <JAG> - Support V9 (run-time) - voorkom: "Cannot Get on query brTables which is not opened. (3159)" */
...
/*------------------------------------------------------------------------
  ...
  do with frame {&frame-name}:
     ...
     */
    if pcDatabase <> ? then
      cTable = getRegistry ('DB:' + getDatabaseName("TO-DATASR", cbDatabaseFilter:screen-value), 'table').  /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
    else 
      assign cTable = ''.
...
/*------------------------------------------------------------------------
  ...
  do with frame {&frame-name}:
    ...
    setRegistry ("DB:" + getDatabaseName("TO-DATASR", getCurrentDatabase()), "table", pcTable ).  /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
...
/*------------------------------------------------------------------------
  ...
  define variable cSessieParameter  as character  no-undo.
  define variable cPostFixTitel     as character  no-undo.
  
  /*
  ** Display the current database and table name in the windowtitle
  */
  /* <JAG> - Support V9 (verbetering) - database.tabel eerst, toon ook Progress versie </JAG> */
  assign
    cSessieParameter  = session:parameter
    cPostFixTitel     = (if cSessieParameter <> "" and cSessieParameter <> ? then
                           cSessieParameter
                         else
                           "")
    cTitleMask        = "&5.&6 &7 - &1 &2 (&3) &4"
    cTitle            = substitute( cTitleMask
                                  , "DataDigger"
                                  , "{&buildnr}"
                                  , "V" + entry(1, proversion, ".")
                                  , (if cPostFixTitel <> '' then '- ' + cPostFixTitel else '')
                                  , getCurrentDatabase()
                                  , getCurrentTable()
                                  , (if gcFieldFilterList <> '' then '(' + gcFieldFilterList + ')'  else '')
                                  )
    C-Win:title       = trim(cTitle, "- ").
  /* </JAG> - Support V9 (verbetering) </JAG> */
...
/*------------------------------------------------------------------------
  ...
  do:
    ...
    /* debug */
    if '{&uib_is_running}' <> '' then cProgDir = 'c:\temp\DD\'.
    /* debug */
...
------------------------------------------------------------------------------*/
  ...
  do with frame {&frame-name}:
    ...
    do:
      assign
        cDatabase = brTables:query:get-buffer-handle(1):buffer-field('cDatabase'):buffer-value    /* <JAG> - Support V9 (compile-time) */
        cDatabase = getDatabaseName("TO-DATASR", cDatabase).                                      /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
...
------------------------------------------------------------------------------*/
  ...
  do with frame {&frame-name}:
    hBuffer = brTables:query:get-buffer-handle(1).
    if hBuffer:available then
      return hBuffer:buffer-field('cTableName'):buffer-value.  /* <JAG> - Support V9 (compile-time) */
    else 
      return "".
  end.
...
/*------------------------------------------------------------------------
  ...
  cDatabase = getDatabaseName("TO-DATASR", gcCurrentDatabase).  /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
  cTable    = gcCurrentTable.
...
------------------------------------------------------------------------------*/
  ...
  do with frame {&frame-name}:
    find bTable 
      where bTable.cDatabase  = getDatabaseName("TO-SCHEMA", getCurrentDatabase())    /* <JAG> - Support AS400 (FC specifiek) - </JAG> */
